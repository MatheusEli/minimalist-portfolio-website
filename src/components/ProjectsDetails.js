    ...
    const projects = [
        {
            ...
            backgroundDescription: "This project was a front-end" +
            ...
            <main className="project-details__box">
                ...
                <div className='project-details__background-box'>
                    <article className='project-details__background'>
                        ...
                        <p className='project-details__background-text'>{project.backgroundDescription}</p>
                    </article>

                    <section className='project-details__previews'>
                        <h3 className='project-details__previews-title'>Static Previews</h3>
                        <img className='project-details__previews-img' src={project.previewImg1} alt="" />
                        <img className='project-details__previews-img' src={project.previewImg2} alt="" />
                    </section>
                </div>
            </main>
        </div>
